...
if ($stateinput) {
  $sql = "SELECT * FROM builtwithshopify WHERE State = '" . $stateinput . "' AND Company IS NOT NULL AND Telephones != 'ph:' AND People IS NOT NULL AND People NOT LIKE '%noemail%'";
}else{
  $sql = "SELECT * FROM builtwithshopify WHERE Company IS NOT NULL AND Telephones != 'ph:' AND People IS NOT NULL AND People NOT LIKE '%noemail%'";
}
...
<nav style="transform: translate(0px, 0px); font-size: 50%;">
  <ul class="pagination justify-content">
    ...
    <li class="page-item"><a class="page-link bg-info text-white" href="builtwithshopify.php">Shopify</a></li>
...
<div class="pagination">
    <ul style="transform: translate(0px,10px);">
      ...
      <center style="transform: translate(250px,-190px);" >
            <form action="builtwithshopify.php" method="post">
